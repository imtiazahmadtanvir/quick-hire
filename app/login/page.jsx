    ...
    <div className={`${epilogue.className} min-h-screen flex`}>
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[#4640DE] relative flex-col justify-center items-center px-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-white/70 text-lg">
            Log in to manage your job applications and discover new opportunities.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-10 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-[#25324B] mb-2">Welcome Back</h1>
          <p className="text-gray-500 mb-8">
            Don&apos;t have an account?{' '}
            <Link href="/signup" className="text-[#4640DE] font-semibold hover:underline">
              Sign Up
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1.5">
                <Link href="#" className="text-sm text-[#4640DE] hover:underline">
                  Forgot password?
                </Link>
              </div>
            </div>
